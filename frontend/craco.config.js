...
const webpackConfig = {
  webpack: {
    alias: {
      ...
      'workbox-webpack-plugin': path.resolve(__dirname, 'plugins/stubs/workbox-webpack-plugin.js'),
    },
